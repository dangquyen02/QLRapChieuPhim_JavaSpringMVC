...
public class confirmInformationController {
	...
	public String huyve(HttpServletRequest request) {
		try {
	...
	public String xacnhanthongtin(HttpServletRequest request, RedirectAttributes redirectAttributes) {
	...
	public ModelAndView hienthixacnhan(HttpServletRequest request) {
