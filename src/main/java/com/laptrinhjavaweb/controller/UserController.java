...
//	 public ModelAndView dangki(@ModelAttribute UserDTO userDTO, HttpServletRequest request, HttpServletResponse response) { 
//		try {
//			//client gui len server bang utf-8
//			request.setCharacterEncoding("utf-8");
//			// server gui len client bang utf-8
...
//			//Nếu nhập đầy đủ các trường...
//			if (!userDTO.getEmail().equals("") && !userDTO.getFullName().equals("") && !userDTO.getPhone().equals("") && !userDTO.getAddress().equals("") && !dateView.equals("") && !userDTO.getPassword().equals("") && !repeat_password.equals("")) {
//				Date dateOfBirth=f.parse(dateView);
//				Boolean check=true;
//				//Kiểm tra nhập lại mật khẩu
//				if (repeat_password.equals(userDTO.getPassword())) {
...
//				}
//				if (repeat_password.equals("") && !userDTO.getPassword().equals("")) {
//					message_repeat_password="hập lại mật khẩu!";
//					request.setAttribute("message_repeat_password", message_repeat_password);
//				}
//			}
//			
