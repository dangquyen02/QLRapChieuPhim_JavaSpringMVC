...
//				request.setAttribute("movieFormat", request.getParameter("movieFormat"));
	...
	public String uploadMultipleFileHandler(
		...
		try {
			...
			if(movieDate.equals("dd/MM/yyyy") || (startDate.before(currentDate2)&& !isEdit) || (startDate.equals(currentDate2) && !isEdit) || movieDuration <= 0 || movieName.trim().isEmpty() || movieName == null  
                ...
                redirectAttributes.addAttribute("movieDate", movieDate);
			...
			System.out.println(files[0].getOriginalFilename().isEmpty());
			...
			if(!files[0].getOriginalFilename().isEmpty() || !files[1].getOriginalFilename().isEmpty()) {
				...
				for (MultipartFile file : files) {
					if(!file.getOriginalFilename().isEmpty()) {
						...
						//String rootPath = "C:\\Users\\dmx\\OneDrive\\Desktop\\RapChieuPhim_SpringMVC\\src\\main\\webapp\\template\\customer\\img\\";
