...
//@Transactional
//@Modifying
//@Query(nativeQuery = true, value = "INSERT INTO ticket(BookingTime, refund, status, ticketCode, totalAmount, idMovie, idUser) VALUES (NOW(), 0, null, ?1, null, ?2, ?3)")
//void addTicket(String ticketCode, int idMovie, int idUser);
//
//@Transactional
//@Modifying
...
//@Transactional
//@Modifying
//@Query(nativeQuery = true, value = "UPDATE ticket SET status = 1, totalAmount = ?1 WHERE id_Ticket = ?2")
//void updateTicket(Float totalAmount, int idTicket);
//
//
//
//@Query(value ="SELECT * FROM ticket  WHERE idUser = ?", nativeQuery = true)
//List<TicketEntity> findByIdUser(@Param("idUser") int idUser );