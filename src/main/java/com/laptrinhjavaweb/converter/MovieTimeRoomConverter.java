...
//@Component
//public class MovieTimeRoomConverter {
//	public MovieTimeRoomDTO toDTO(MovieTimeRoomEntity movieTimeRoomEntity) {
//		MovieTimeRoomDTO dto = new MovieTimeRoomDTO();
//		dto.setBeginTime(movieTimeRoomEntity.getBeginTime());
//		dto.setDate(movieTimeRoomEntity.getDate());
//		dto.setEndTime(movieTimeRoomEntity.getEndTime());
//		dto.setIdMovie(movieTimeRoomEntity.getIdMovie());
//		dto.setIdRoom(movieTimeRoomEntity.getIdRoom());
//		dto.setStatus(movieTimeRoomEntity.getStatus());
//		
//		dto.setIdMovieTimeRoom(movieTimeRoomEntity.getIdMovieTimeRoom());
//		return dto;
//	}
//	
//}
