...
<body class="bg-dark">
    <div class="content-information" style="height: auto;" >
        <div class="d-flex justify-content-center">
            <div class="col-md-4 frm-changepasswork mt-5 mb-5">
            	<c:if test="${not empty message}">
					...
					<script>alert('cập nhật thành công!'); window.location.href = './trangchu'; </script>
    ...
    <div class="content-information" style="height: auto;" >
        <div class="d-flex justify-content-center">
            <div class="col-md-4 frm-changepasswork mt-5 mb-5">
                ...
                <form action="edit-user" class="mt-4" method="get">
                    <div class="frm-information-content row justify-content-center">
                        <div class="col-md-10">  
                            <div class="col-auto text-center mb-4 mt-2">
                                <h3 class="text-color-main-100">Thông tin cá nhân</h3>
                        ...
                        <div class="col-md-10">
                            <div class="form-floating mb-2 mt-3">
                                <input type="text" class="form-control" name="fullName" id="name" placeholder="">
                        ...
                        <div class="col-md-10">
                            <div class="form-floating mb-2 mt-3">
                                <input type="date" class="form-control" value="${dateformat }" name="dateOfBirth" id="dob" placeholder="">
                                <label for="dob">Ngày sinh</label>
                            </div>
                            <c:if test="${not empty message_dateOfBirth}">
								<div style="padding: 0px;color: red;margin: 0;" class="alert alert-${alert}">${message_dateOfBirth}</div>
