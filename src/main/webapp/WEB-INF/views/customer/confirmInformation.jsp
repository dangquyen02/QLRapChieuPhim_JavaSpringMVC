	...
	<div class="confirmInformation bg-dark">
		<div class="container">
			...
			<div
				...
				<a class="btn" href="submitOrder?comboPrice=${comboPrice }&chairSumPrice=${chairSumPrice }&idTicket=${idTicket }&idChairs=${idChairs }&idTimeRoom=${idTimeRoom}" >XÁC
					NHẬN</a> 
				<a class="btn" href="huyve?idChairs=${idChairs }&idTimeRoom=${idTimeRoom}&comboPrice=${comboPrice }&chairSumPrice=${chairSumPrice }">HỦY GIAO DỊCH</a>
			</div>
		</div>
	</div>
	<script
		...
		<div class="container">
			<div class="confirmInformation-content col-xl-6 pt-4">
				...
				<div class="confirmInformation-film mt-4">
					<p>Phòng: ${phongchieu }</p>
					<p>Tên Phim: ${tenphim }</p>
					<p>Suất chiếu: ${suatchieu } - ${ngaychieu }</p>
					<p style="color: #33aba5;">Số ghế: ${chairQuantity }</p>
					<div class="d-flex ">
						<p style="color: #ea593c; margin-right: 4px;">${chairCode }:</p>
						<p>${chairPrice } đ</p>
					</div>
				</div>
				<div class="confirmInformation-combo mt-4">
			...
			<div
				class="mt-4 confirmInformation-footer d-flex gap-2 justify-content-between">
				<a class="btn" href="xacnhanve?comboPrice=${comboPrice }&chairPrice=${chairPrice }&comboQuantity=${comboQuantity }&chairQuantity=${chairQuantity }">XÁC NHẬN</a> 
				<a class="btn" href="trangchu">HỦY GIAO DỊCH</a>
			</div>
		</div>
	</div>
	<script
