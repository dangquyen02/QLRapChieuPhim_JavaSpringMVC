			...
			<div class="dashboard-ecommerce">
				<div class="container-fluid dashboard-content ">
					...
					<div class="ecommerce-widget">
						<div class="box box-primary">
							<div class="box-body">
								<form action="/admin/movie" method="get">
									<div class="form-row d-flex align-items-center">
										<div class="form-group col-sm-3">
											<label for="">Phim:</label> <select class="form-control"
												id="movieName1" name="movieName1">
												<option value="movie1">--Chọn loại phim--</option>
										...
										<div class="form-group col-sm-3">
											<label for="">Chọn ngày chiếu:</label> <input
												class="form-control" id="daterange" value="dd/MM/yyyy">
										</div>
										<div class="form-group col-sm-6">
											<label for="">Nhập phim cần tìm: </label>
											<div class="input-group">
												<input type="text" name="txtsearch" class="form-control"
													autofocus>
												<div class="input-group-append">
													<button class="btn btn-info" type="submit" name="but">
														<i class="fa fa-search"></i>
													</button>
													<a href="movie_add.html" class="btn btn-success"
														style="margin-left: 5px;"> <i class="fa fa-plus"></i>
														Bổ sung
													</a>
												</div>
								...
								<div>
									<p style="margin: 10px 0 10px 0">
										Có<strong> 5</strong> phim trong tổng số <strong>1</strong>
										trang
									</p>
									<div class="table-responsive mt-2">
										<table class="table table-bordered table-hover table-striped">
												...
												<c:if test="${not empty listmovie}">
													<c:forEach items="${listmovie}" var="movie">
														<tr>
															...
															<td>${movie.getMovieDuration()} phút</td>
															<td>${movie.getDirector()}</td>
															<td>${movie.getActors()}</td>
															<td>${movie.idMovieType.getTypeName()}</td>
															<td>${movie.getMovieFormat()}</td>
															<td class="text-center"><a href="movie_edit.html"
																class="btn btn-xs btn-info" style="width: 35px;"> <i
																	class="fa fa-edit"></i>
															...
															<tbody>
																<tr>
																	...
																	<td><img style="width: 100px;"
																		src="https://play-lh.googleusercontent.com/cp94GJsYWZCrf4bmYp3yZkuN7FAaorxZWh008_DUji0Qj2cfyILd7-h_611zbbiUEkg=w240-h480-rw"
																		alt="nophoto"></td>
																</tr>
																<tr>
																	<th scope="row">Tên phim:</th>
