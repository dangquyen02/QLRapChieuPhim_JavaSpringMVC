						...
						<form class="form-horizontal" action="save-movie" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div>
									...
									<img class="img-thumbnail" src='<c:url value='${(message != null && mainImageBase64 != "")? "data:image/jpeg;base64," + mainImageBase64 : "/template/customer/img/"}${movie.mainImage}'/>' alt="no-img">
