								...
								<div class="form-row align-items-center">
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group">
											<c:set var="test" value="dd/MM/yyyy" />
											...
											<c:if test="${dateRange.equals(test)}">
												<input type="text" class="form-control" style="height: 39px" id="dateRange"
													name="dateRange" value="dd/MM/yyyy" />
											</c:if>
										</div>
									</div>
								...
								<div class="row"
									...
									<ul class="pagination">
										<li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
											<a class="page-link"
											href="<c:url value="/admin/time?page=0&size=5&searchValue=&dateRange=dd/MM/yyyy&idRoom=0&result=1" />"><i
