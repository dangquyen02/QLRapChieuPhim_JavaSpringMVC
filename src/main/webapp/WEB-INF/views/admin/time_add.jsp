									...
									<div class="form-group col-md-1 ">
										...
										<c:if test="${empty timeInput}">
											<input class="timeInput" id="timeInput" placeholder="hh:mm"
												name="timeInput"
												style="width: 100%; height: 38px; font-size: 14px; line-height: 1.42857143; color: #71748d; background-color: #fff; background-image: none; border: 1px solid #d2d2e4; border-radius: 2px"
							...
							<div>
								...
								<div class="text-right mt-4">
									<a data-toggle="modal" data-target="#myModal"
										...
										href="<c:url value='time?page=0&size=5&searchValue=&dateRange=dd/MM/yyyy&idRoom=0&result=1'/>"
